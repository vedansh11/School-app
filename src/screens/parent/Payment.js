...
const PaymentOrderScreen = ({ navigation }) => {
  ...
  const dummyData = [
    {
      label_name: "Installment 1",
      structure_name: "Half",
      amount: "25000",
      final_amount: 50000,
      order_status: "paid", // or "unpaid"
      due_date: "2025-06-10",
            ...
            >
              ...
              >
                <View>
                  ...
                  <Text style={stylesCommon.PaymentNo}>{"$ " + "65000"}</Text>
                </View>
                <View>
                  <Text style={stylesCommon.PaymentTextTitle}>
                    {"Pay Only"}
                  ...
                  <Text style={stylesCommon.PaymentNo}>{"$ " + "60000"}</Text>
                </View>
              </View>
            </View>
          )}
