...
const ParentAttendance = ({ route, navigation }) => {
    ...
    async function AddLeaveAPI() {
       ...
       // loginFormData.append("toDate",moment(toDate).format('YYYY-MM-DD'))
        ...
        axiosCallAPI('post', Utills.LEAVE_SAVE, loginFormData, requestOptions, true,  navigation)
            .then((response) => {
    ...
    const MyTabBar = ({ state, descriptors, navigation, position }) => {
        return (
            <View style={{
                flexDirection: 'row', backgroundColor: color.COLOR_SECONDARY,
                ...
                {state.routes.map((route, index) => {
                    ...
                    return (
                        <TouchableOpacity
                            ...
                            onPress={onPress}
                            style={{
                                backgroundColor: isFocused ? color.WHITE : color.COLOR_SECONDARY,
                ...
                }
                {
                    ...
                    <TouchableOpacity style={stylesCommon.inputMainView}
                        ...
                        <DatePicker
                            ...
                            onConfirm={(date) => {
                                setToDateOpen(false)
                                if ((new Date(fromDate) > new Date(date)) || (new Date(date) < new Date(fromDate))) {
